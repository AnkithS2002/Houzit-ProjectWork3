...
public class PGFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_p_g, container, false);
...
//                Intent intent = new Intent(getActivity(), ListItems_Recyclerview.class);
                Intent intent = new Intent(getActivity(), RecyclerViewPG.class);
        ...
        ownerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), PostPropertyPG.class);
                startActivity(intent);
            }
        });
