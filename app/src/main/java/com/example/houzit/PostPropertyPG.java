...
public class PostPropertyPG extends AppCompatActivity {
    ...
    private EditText laundry;
    private EditText food;
    private EditText sharing;
    private EditText parking;
    private EditText housekeeping;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_property_pg);
        ...
        storageReference= FirebaseStorage.getInstance().getReference().child("PGDetails");

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(PostPropertyPG.this, android.R.layout.simple_list_item_1, colleges);
        autoCompleteTextView1.setAdapter(adapter);
        ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(PostPropertyPG.this, android.R.layout.simple_list_item_1, areaNames);
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String PROPERTYTYPE = "PG";
                final String OWNERNAME = ownerName.getText().toString();
                final String PGNAME = pgName.getText().toString();
                ...
                final String LAUNDRY = laundry.getText().toString();
                final String FOOD = food.getText().toString();
                final String SHARING = sharing.getText().toString();
                final String PARKING = parking.getText().toString();
                final String HOUSEKEEPING = housekeeping.getText().toString();
                ...
                if(PGNAME!=null && OWNERNAME != null && OWNERCONTACT !=null && OWNEREMAIL != null && RENTAMT != null && DEPOSITAMT != null
                        && GENDER != null && LAUNDRY != null && FOOD != null && SHARING != null && PARKING != null && HOUSEKEEPING != null
                        && SECURITY != null && VEGNONVEG != null && DESCRIPTION != null && isImageAdded!=false && COLLEGE != null && AREA != null){
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            storageReference.child(key+".jpg").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    hashMap.put("HouseKeeping", HOUSEKEEPING);
                                    ...
                                    databaseReference.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            Toast.makeText(PostPropertyPG.this, "AD successfully posted",Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                        @Override
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(PostPropertyPG.this, "AD not posted properly",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            });
