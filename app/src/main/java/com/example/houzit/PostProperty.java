...
public class PostProperty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(PostProperty.this, android.R.layout.simple_list_item_1, houseType);
        autoCompleteTextView2.setAdapter(adapter2);
        ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(PostProperty.this, android.R.layout.simple_list_item_1, areaNames);
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String DATEAVL = dateAvl.getText().toString();
                ...
                && AREASQFT != null && FACING != null && FURNISHING != null && WATER != null && PARKING != null && DATEAVL != null
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    databaseReference.setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(PostProperty.this, "AD not posted properly",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            });
